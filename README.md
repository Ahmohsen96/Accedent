...
This project is a simple form to add accident datails i prefer to make it simple and record all records in accident tale and using livewire to make simple view 
...
1. **Clone the Repository**
   ...
   ```bash
   git clone [https://github.com/yourusername/your-repository.git](https://github.com/Ahmohsen96/Accedent.git)
   cd your-repository
...
http://127.0.0.1:8000/accident-report
...
I used livewire and make component to add fields to database and component to view 
I utilized Laravel's built-in features such as Eloquent ORM for database interactions and Blade templating engine for rendering views.
